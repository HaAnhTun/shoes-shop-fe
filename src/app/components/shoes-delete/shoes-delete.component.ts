...
@Component({
  selector: 'app-shoes-delete',
  templateUrl: './shoes-delete.component.html',
  styleUrls: ['./shoes-delete.component.css'],
  providers: [MessageService],
})
export class ShoesDeleteComponent {
  ...
  ngOnInit() {
    this.ShoesService.getShoesRemoved().subscribe((data: any) => {
      this.Shoes = data;
    });
